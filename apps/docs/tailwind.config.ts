...
import { preset, preset_fumadocs } from "@civictechmy/myds-style";
...
const config: Config = {
  content: [
    ...
    // This is a workaround; In final build, @civictechmy/myds-style output full css for users to import
