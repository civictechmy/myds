...
export const SearchBarControlledStateExample = () => {
...
export function SearchBarResultsExample() {
  const results = notableMalaysians.slice(0, 5);
...
export function SearchBarGroupedResultsExample() {
  const results = notableMalaysians.filter((_, i) => i % 10 === 0);
...
export function SearchBarClearButtonExample() {
