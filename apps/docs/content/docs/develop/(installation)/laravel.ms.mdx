...
<Steps>
  ...
  <Step>
    ...
    ```package-install
    npm i @civictechmy/myds-react @civictechmy/myds-style
    // ☝️ Menggunakan kit permulaan (Laravel Breeze atau Jetstream)

    npm i @civictechmy/myds-react @civictechmy/myds-style react react-dom @vitejs/plugin-react
  ...
  <Step>
    ...
    @import "@civictechmy/myds-style/full.css";
    ```
